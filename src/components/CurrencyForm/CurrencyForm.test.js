...
describe('Component CurrencyForm', () => {
  ...
  it('should run action callback with proper data on form submit', () => {
    ...
    for(const testObj of testCases){
      ...
      const firstSelect = screen.getByTestId('firstSelect');
      const secondSelect = screen.getByTestId('secondSelect');
      // set test values to fields
      userEvent.type(amountField, testObj.amount);
      userEvent.selectOptions(firstSelect, testObj.from);
      userEvent.selectOptions(secondSelect, testObj.to);
